...
{
    @ApiModelProperty(name = "instructid", value="primary key for Instructor ID", required = true, example = "1")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private long instructid;

    @ApiModelProperty(name = "instructname", value="primary key for Instructor name", required = true, example = "Jane")
